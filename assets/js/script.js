...
function saveContent() {
    ...
    // var toStorage = fromStorage && fromStorage[taskNum].time ? fromStorage : new Array(24);
    var saveTask = {
        time: taskNum,   // this.previousElementSibling.previousElementSibling.textContent,
